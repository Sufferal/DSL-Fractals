...
class SimpleArithmeticParser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SimpleArithmeticParser.TermContext)
            else:
                return self.getTypedRuleContext(SimpleArithmeticParser.TermContext,i)
    ...
    def expr(self):
        ...
        localctx = SimpleArithmeticParser.ExprContext(self, self._ctx, self.state)
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SimpleArithmeticParser.FactorContext)
            else:
                return self.getTypedRuleContext(SimpleArithmeticParser.FactorContext,i)
    ...
    def term(self):
        ...
        localctx = SimpleArithmeticParser.TermContext(self, self._ctx, self.state)
    ...
    class FactorContext(ParserRuleContext):
        ...
        def NUMBER(self):
            return self.getToken(SimpleArithmeticParser.NUMBER, 0)
    ...
    def factor(self):
        ...
        try:
            ...
            if token in [7]:
                self.enterOuterAlt(localctx, 1)
                self.state = 22
                self.match(SimpleArithmeticParser.NUMBER)
                pass
            elif token in [5]:
